...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      checkboxInput(
        inputId = "do.boundary.refine",
        label = "refine the segment boundaries based on the grid of heterozygous probes by all probes with LRR data",
        value = FALSE
      ),
